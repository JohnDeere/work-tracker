...
public class LimitConfigurationTest extends BaseMockConnectionLimit {
    ...
    public void connectionLimitsSet() {
        assertConnectionLimits(configuration.connectionLimits().getConnectionLimits(), MAX_LIMIT);
    }
