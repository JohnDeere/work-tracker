...
public class PathVariablesToMDCTest {
    ...
    public void keyCleanserBeanExist() {
        assertThat(context.getBean("keyCleanser"), notNullValue());
    }
    ...
    public void testIdInMDC() throws Exception {
        ...
        assertThat(response.getContentAsString(), containsString("\"test_id\":\"1\""));
    }
    ...
    public void userIdRoleInMDC() throws Exception {
        ...
        assertThat(contentAsString, containsString("\"path_user_name\":\"10\""));
        assertThat(contentAsString, containsString("\"role\":\"admin\""));
    }
    ...
    public void queryGuidInMDC() throws Exception {
        ...
        assertThat(response.getContentAsString(), containsString("\"query_guid\":\"123456789\""));
    }
    ...
    public void oauthTokenInMDC() throws Exception {
        ...
        assertThat(response.getContentAsString(), containsString("\"oauth_token\":\"12345\""));
    }
    ...
    public void sumInMDC() throws Exception {
        ...
        String contentAsString = response.getContentAsString();
        assertThat(contentAsString, containsString("\"first\":\"1\""));
        assertThat(contentAsString, containsString("\"second\":\"2\""));
    }
    ...
    public void idElapsedMsAndTokenInMDC() throws Exception {
        ...
        String contentAsString = response.getContentAsString();
        assertThat(contentAsString, containsString("\"path_user_name\":\"123\""));
        assertThat(contentAsString, containsString("\"oauth_token\":\"456\""));
        assertThat(contentAsString, containsString("\"logic_elapsed_ms\":\"5\""));
    }
}
